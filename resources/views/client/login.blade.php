                ...
                <div class="col-md-7">
                    <div class="login__section__form">
                        <form method="POST" action="">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <a href="{{ route('auth/google') }}"
                                           class="btn btn-outline-danger login__section__form__with__gg">Login with
                                            google</a>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <a href="{{route('auth/facebook')}}"
                                           class="btn btn-outline-primary login__section__form__with__fb">Login with
                                            facebook</a>
                                    </div>
                                </div>
                            </div>
                            <div class="login__section__form__text mb-3">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                        <a href="{{ route('register') }}" class="login__section__form__text__register">Create
                                            new account</a>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                            ...
                            <button type="submit" class="btn btn-outline-success login__section__form__btn-login">
                                Login
                            </button>
                        </form>
                    </div>
